...
\textbf{Область видимости} (scope) — это контекст, в котором переменные могут быть видимыми и доступны для использования. В R существует несколько уровней областей видимости: глобальная и локальная.
{\fontsize{10}{10}\selectfont
		\begin{verbatim}
    x <- "глобальная"
